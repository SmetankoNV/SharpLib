...
namespace SharpLib.Source.Helpers.Math.Crc
{
    ...
    public class Crc16
    {
        ...
        /// </summary>
        private static readonly ushort[] _tableCrc16 =
        {
        ...
        public static ushort Get(byte[] arr, int index, int size)
        {
            ...
            {
                crc16 = (ushort)(_tableCrc16[(crc16 >> 8) & 0xFF] ^ (crc16 << 8) ^ arr[index + i]);
            }
        ...
        public static bool Check(byte[] arr, int index, int size, bool fill)
        {
            var crc16 = Get(arr, index, size);
            ...
            {
                var temp = arr.GetByte16Ex(index + size, Endianess.Little);
